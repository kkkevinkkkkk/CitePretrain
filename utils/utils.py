...
OPENAI_MODELS = ["gpt-4", "gpt-3.5-turbo", "gpt-4-1106-preview",
                 "gpt-4-0125-preview", "gpt-4-turbo", "gpt-4o-mini", "gpt-4o",
                 "ft:gpt-4o-2024-08-06:duke-university:faithful-93:A3S28crx",
                 "gpt-4.1", "gpt-4.1-mini", "gpt-4.1-nano"]

def read_jsonl(file_path, return_df=True, show_info=True, start_idx=None, end_idx=None):
...
def save_jsonl(data, file_path, show_info=True):
